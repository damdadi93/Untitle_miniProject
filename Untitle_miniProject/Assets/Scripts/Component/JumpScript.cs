...
public class PlayerJump : MonoBehaviour
{
    ...
    public Transform jumpStandard;//땅인지 탐지하는 기준
    ...
    void Update()
    {
        ...
        Debug.DrawRay(jumpStandard.position, Vector2.down* jumpScope, new Color(0, 1, 0));    //아래로빔쏨
        RaycastHit2D rayHit = Physics2D.Raycast(jumpStandard.position, Vector2.down, jumpScope, LayerMask.GetMask("Ground"));//땅에 붙어있는지 감지
